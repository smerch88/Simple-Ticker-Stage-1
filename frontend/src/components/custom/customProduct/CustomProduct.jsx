  ...
  const submitConfig = () => {
    const data = {
      crypto_section: {
        ...
        crypto_price: [
          0.34397, 0.067, 20000, 1400, 22.73, 0.000104, 260.73, 41.92, 0.0273,
          7.59,
        ],
  ...
  return (
    <div className="custom__product">
      ...
      <div className="custom__product__descr">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Rhoncus diam
        parturient metus eget eu massa. Lorem ipsum dolor sit amet, consectetur
        adipiscing elit. Rhoncus diam parturient metus eget eu massa. Lorem
        ipsum dolor sit amet, consectetur adipiscing elit. Rhoncus diam
        parturient metus eget eu massa. Lorem ipsum dolor sit amet, consectetur
        adipiscing elit.
      </div>
      <button onClick={submitConfig} className="btn">
        Apply
      </button>
    </div>
  );
